...
using PulkitMidha.ShooterSurvivor.Runtime.Data.Enemies;
...
namespace PulkitMidha.ShooterSurvivor.Runtime.Actors.Enemies
{
    internal sealed class EnemyActor : MonoBehaviour, IEnemyActor
    {
        ...
        public void AttackPlayer(IPlayerController player)
        {
        ...
        {
            var player = args.Collider.GetComponentInParent<IPlayerController>();
            if (player == null)
            {
                return;
            }
