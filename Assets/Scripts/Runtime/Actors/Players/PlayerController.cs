...
using PulkitMidha.ShooterSurvivor.Runtime.Components.Animation;
using PulkitMidha.ShooterSurvivor.Runtime.Components.Collectables;
using PulkitMidha.ShooterSurvivor.Runtime.Components.Input;
using PulkitMidha.ShooterSurvivor.Runtime.Components.Rotation;
using PulkitMidha.ShooterSurvivor.Runtime.Components.Tracking;
using PulkitMidha.ShooterSurvivor.Runtime.Components.Triggers;
using PulkitMidha.ShooterSurvivor.Runtime.Data.Players;
...
{
    internal sealed class PlayerController : MonoBehaviour, IPlayerController
    {
        [Header("Player Data")]
        [Required]
        [SerializeField]
